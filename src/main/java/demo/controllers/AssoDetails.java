...
public class AssoDetails {
    ...
    // Constructeur prenant l'ID de l'association comme argument
    public AssoDetails(int associationId) {
    ...
    private void loadAssociation(int id) {
        Association myAsso = associationRepo.getAssociationById(id); // Fetch association data
    ...
    private void loadProject(int id) {
        ...
        List<Projet> projets = projetRepo.getProjetsProfilById(id);
    ...
    private void loadMember(int id) {
        ...
        List<Membre> membres = memberRepo.getMembersProfilById(id);
